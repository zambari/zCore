...
namespace Z
{
	public static class zPath
	{
		...
		public static void CreateCopyFromStreamingAssets(
			string pathRelativeToStreamingAssets,
			string pathrelativeToApplicationRoot = null)
		{
			...
			if (pathrelativeToApplicationRoot == null)
				pathrelativeToApplicationRoot = FileName(pathRelativeToStreamingAssets);
		...
		public static void WriteJson<T>(this T obj, string path, bool silent = true)
		{
			...
			if (!silent) Debug.Log("written to " + path);
		}
	}
}
