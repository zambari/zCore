...
namespace Z
{
    ...
    public class Damper3DAngle
    {
        ...
        {
            //get { return new Vector3(xDamp.targetValue%360,yDamp.targetValue%360,zDamp.targetValue%360); }
            get { return new Vector3(xDampA.currentValue, yDampA.currentValue, zDampA.currentValue); }
            set
            {

                xDampA.currentValue = value.x;
                yDampA.currentValue = value.y;
                zDampA.currentValue = value.z;
            }
        }
        public Vector3 targetValue
        {
